...
axios.get('https://asjmjwqroopycagralvg.supabase.co/rest/v1/frontdoortvtable?select=*', {headers:{'apikey':'ey', 'Content-Type':'application/json'}}).then(function (response) {
  // handle success
